  ...
  const samplePosts = [
    {
      ...
      content: 'This is the first post in our pure JavaScript monorepo blog. Built with Fastify, MongoDB, and Vanilla JS for maximum performance.',
      excerpt: 'Welcome to our high-performance JavaScript blog built with modern tools.',
      author: 'dunamismax',
      createdAt: new Date(),
      updatedAt: new Date(),
    ...
    },
    {
      ...
      content: 'Learn how to build lightning-fast web applications using pure JavaScript, esbuild, and modern web standards.',
      excerpt: 'Discover the secrets to creating blazing-fast web applications.',
      author: 'dunamismax',
    ...
    },
    {
      ...
      content: 'Explore how Web Components provide a framework-agnostic way to build reusable UI elements with native browser APIs.',
      excerpt: 'Web Components offer a powerful way to create reusable UI elements.',
      author: 'dunamismax',
